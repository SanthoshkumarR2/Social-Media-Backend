...
export const posts = [
  ...
  },
  {
    ...
    comments: [
      ...
      "Man I'm bored",
      "What should I do?",
      "I'm going to play video games,etc",
    ],
  },
  {
    _id: new mongoose.Types.ObjectId(),
...
// Include timestamps for users and posts
...
export const newPosts = [
  {
    ...
    picturePath: "new_post.jpg",
    userPicturePath: "john_doe.jpg",
    likes: new Map(),
    comments: [
      { userId: userIds[1], text: "This is a comment" },
      // ... add more comments if needed
    ],
    createdAt: timestamp,
    updatedAt: timestamp,
  },
  // ... add more new posts if needed
];